...
1. [設定訂閱 和激活屬性源](t-crs-usecase.md#task_1ACA21198F0E46A897A320C244DFF6EA)
...
1. 建立 `.csv`.
   ...
   >[!NOTE]
   >
   >在此程式後面的步驟中，您可以拖放`.csv`以上傳檔案。 不過，如果您[透過 FTP 上傳](t-upload-attributes-ftp.md#task_591C3B6733424718A62453D2F8ADF73B)，則另外還需要一個與 `.csv` 同名的 `.fin` 檔案。
...
1. [建立客戶屬性來源及上傳資料](t-crs-usecase.md#task_BCC327B2A0EF4A1BBB2934013AB92B78)，如下所述。
