...
uuid: 9d0e364-889b-45db-b190-85c0930 a101 e
...
您將需要 CRM 的存取權或您公司的其他類似資料。上傳至Experience Cloud的資料必須是 [!DNL .csv] 檔案。如果您透過FTP或sFTP上傳，也可以上傳 [!DNL .fin] 檔案。

客戶屬性的設計是為了每天處理幾個檔案。為了減少大量小檔案進行整合處理的問題，從相同組織中的30分鐘內傳送的檔案會路由至較低優先順序的佇列。
...
<table id="table_A9849CC9AA784763921DE057F0F61515"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E157EE6F98914EADA0C103D1D1E705D3"> 
      <li id="li_84FBD455DD164A28AC16F4A5AB19E4B3">每個上傳的FTP檔案大小上限為GB。 </li> 
      <li>每個上傳的最小檔案大小限制為10MB。 </li>
      <li>您可以每半小時上傳一個檔案。 </li>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>上傳客戶屬性資料時，如果您要快速上傳數個檔案，尤其當檔案很大時，請確定先前檔案已過處理，再上傳下一個檔案。您可以透過檢查上一個檔案移至客戶屬性FTP帳戶中已處理或失敗的資料夾，來監控此項目。 </p> <p> 將大型檔案分割為較小的檔案並快速提交檔案可能會拖慢處理速度，除非您可以確保每個檔案在提交下一個檔案之前都已完全處理。 </p> </td> 
  </tr> 
  <tr> 
...
在 **[!UICONTROL 「Experience Cloud]** &gt; **[!UICONTROL 人員]** &gt; **[!UICONTROL 客戶屬性]**」中：
