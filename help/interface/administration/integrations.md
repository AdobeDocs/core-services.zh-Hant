...
本頁面說明開始整合Experience Cloud應用程式的幾種方法。 如需詳細資訊，請在Experience League上瀏覽我們的[整合教學課程影片](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html?lang=zh-Hant)資料庫。
...
* 在Experience League上[Adobe Advertising檔案](https://experienceleague.adobe.com/docs/advertising.html?lang=zh-Hant)
