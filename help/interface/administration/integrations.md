...
本頁面說明開始整合CX Enterprise應用程式的幾種方法。 如需詳細資訊，請瀏覽Experience League上的[整合教學課程影片](https://experienceleague.adobe.com/docs/experience-platform/tags/home.html)資料庫。
...
* 讓您成為管理員。
* [實作CX Enterprise ID服務](https://experienceleague.adobe.com/docs/id-service/using/home.html)。
...
* [CX Enterprise ID服務](https://experienceleague.adobe.com/docs/id-service/using/home.html)
...
請參閱[CX Enterprise ID服務](https://experienceleague.adobe.com/docs/id-service/using/home.html)
...
* [將Audience Manager區段傳送至Analytics](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/experience-cloud-destinations/create-analytics-destination.html)
* [Adobe Target資料整合](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-other-applications/aam-target-integration.html)
...
說明： [設定AEM Assets與CX Enterprise和Creative Cloud的整合](https://experienceleague.adobe.com/docs/)
...
* AEM
* Creative Cloud
* [CX企業版](https://experienceleague.adobe.com/docs/)
