...
| [透過目錄信任設定組織](https://helpx.adobe.com/enterprise/using/directory-trust.html) | 針對其他組織已宣告的網域驗證您的使用者。 如需尋找和切換組織的相關資訊，請參閱[CX Enterprise中的組織](organizations.md)。 |
...
| 說明連結 | 說明 |
| ------- | ------- |
| [重設您的Adobe ID](https://helpx.adobe.com/account/individual/sign-in-and-security/security-and-recovery/cant-sign-in-to-adobe-account.html) | 登出，然後按一下&#x200B;**[!UICONTROL Get help signing in]** > **[!UICONTROL Reset your password]**。 |
