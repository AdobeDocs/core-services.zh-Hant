...
| 說明連結 | 說明 |
| ------- | ------- |
| [重設您的Adobe ID](https://helpx.adobe.com/tw/account/individual/sign-in-and-security/security-and-recovery/cant-sign-in-to-adobe-account.html) | 登出，然後按一下&#x200B;**[!UICONTROL 取得協助登入]** > **[!UICONTROL 重設密碼]**。 |
