...
* 請參閱本頁面的[將 Analytics 存取權指派給產品設定檔](admin-getting-started.md#task_040673FE3E3E429B9531FBCB8B6A4391)。
...
* [!DNL Microsoft® Edge] (Microsoft®已 [停止](https://www.microsoft.com/zh-tw/WindowsForBusiness/End-of-IE-support) 支援Internet Explorer 8、9和10。因此，Adobe不會修正針對這些特定版本Internet Explorer所回報的問題。)
* [!DNL Google Chrome]
* [!DNL Firefox]
* [!DNL Safari]
* [!DNL Opera]
