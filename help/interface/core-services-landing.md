...
Adobe Experience Platform可集中管理整個企業的資料和內容。Product documentation is located on [Adobe.io](https://www.adobe.io/apis/experienceplatform/home/services.html).
...
| [啟動](activation/activation.md) | 網站和應用程式的資料收集與技術啓動。其功能包括:<ul><li>Experience Platrm Launch(最新標籤管理解決方案)</li><li>動態標籤管理</li><li>觸發器</li></ul> |
