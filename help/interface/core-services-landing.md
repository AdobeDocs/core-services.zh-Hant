---
description: 瞭解Experience Cloud使用者和產品管理、People （受眾和客戶屬性）、Journey Orchestration、Offers、Places、Experience Platform和Mobile Services。
...
本檔案適用於Experience Cloud中統一標題的功能，例如 [!DNL People] 服務([!DNL Audience Library] 和 [!DNL Customer Attributes])、Experience Cloud、Cookie、帳戶偏好設定、通知等的使用者和產品管理。
...
| [人員 —  [!DNL Audience Library]](audience-library.md) | 對象是訪客的集合 (訪客 ID 的清單)。Adobe的 [!DNL Audience Library] 可讓您管理將訪客資料轉譯為受眾細分的過程。   |
