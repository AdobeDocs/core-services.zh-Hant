...
1. 確認您隸屬於正確的組織。
   ...
   **確認您的組織**
   ...
   >[!NOTE]
   >
   >貴組織的管理員可依IP位址限制對Adobe產品的存取。 若是如此，您可能在登入Experience Cloud或切換至啟用此功能的組織後，收到錯誤。 如需詳細資訊，請參閱[依IP位址限制產品存取](https://helpx.adobe.com/tw/enterprise/using/ip-based-access.html)。
