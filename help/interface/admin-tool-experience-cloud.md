...
管理員可以在管理工具中，檢視所有 Experience Cloud 使用者和原則及其詳細資訊，且可將清單加以排序及篩選。使用者詳細資訊包括使用者的產品存取權、角色，以及上次存取的資訊。原則詳細資訊包括原則的 (產品個人資料) 使用者、群組、開發人員、整合和管理員清單，以及原則的詳細權限和資源資訊。
...
本區段顯示使用者所有產品個人資料成員資格的完整清單。

| 元素 | 說明 |
|---------|----------|
| [!UICONTROL 產品] | 與產品個人資料相關聯的產品名稱。 |
| [!UICONTROL 例項] | 與產品和產品個人資料相關聯的例項名稱 (例如登入公司或租用戶)。 |
| [!UICONTROL 產品個人資料] | 產品個人資料的不重複名稱。 |
| [!UICONTROL 依群組指派] | 為使用者與產品個人資料建立關聯的使用者群組名稱。空白結果表示使用者是直接指派至產品個人資料，而非透過群組。 |
| [!UICONTROL 產品角色] | 產品個人資料中的使用者角色指派。目前此資訊僅適用於 Adobe Target 產品個人資料。 |
...
* 依名稱搜尋產品個人資料。搜尋會比對您輸入的文字字串。
* 依遞增或遞減值排序欄。此排序適用於「[!UICONTROL 產品個人資料]」、「[!UICONTROL 產品]」、「[!UICONTROL 例項]」、「[!UICONTROL 使用者人數]」和「[!UICONTROL 開發人員人數]」欄。
...
每個產品個人資料的詳細檢視都會顯示產品個人資料主體 (使用者、群組等) 的重要詳細資訊，也會顯示產品個人資料啟用的權限和資源。

產品個人資料的詳細資訊可匯出為 CSV 檔案。[!UICONTROL 「匯出 CSV」]選項會產生兩個 CSV 檔案：
...
本區段顯示指派給產品個人資料的所有使用者、使用者群組、開發人員、整合和管理員的完整清單。

| 標記 | 說明 |
|---------|----------|
| [!UICONTROL 使用者] | 產品個人資料中包含的使用者清單。使用者群組關聯會顯示在「[!UICONTROL 依群組指派]」欄中。 |
| [!UICONTROL 使用者群組] | 與產品個人資料相關聯的使用者群組清單。 |
| [!UICONTROL 開發人員] | 與產品個人資料相關聯的開發人員清單。 |
| [!UICONTROL 整合] | 與產品個人資料相關聯的整合清單。 |
| [!UICONTROL 管理員] | 與產品個人資料關聯的管理員清單。 |

## 詳細的權限和資源清單

本區段顯示完整的產品個人資料可用權限和資源清單。產品個人資料中包含的權限和資源會加上「✔」標示。權限和資源清單會分類為各個標記和欄，以便檢視。標記和欄會顯示適用於目前產品的區段清單。
