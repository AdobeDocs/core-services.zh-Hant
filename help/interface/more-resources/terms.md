...
| **訪客ID服務/ ECID** | 跨解決方案使用的永久性訪客識別碼；通常使用標籤或網頁SDK部署。 在舊版Analytics討論中通常參照為&#x200B;**MID**。 檢視[訪客ID服務總覽](https://experienceleague.adobe.com/docs/id-service/using/home.html)。 | 與單一應用程式的舊版Cookie名稱或&#x200B;**Experience Platform Identity Service**&#x200B;概念不同，不過這些概念在實施中可能有所關聯。 |
