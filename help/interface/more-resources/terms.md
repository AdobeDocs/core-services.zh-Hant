...
| **[!UICONTROL Experience Cloud ID服務] (ECID)** | 無特殊用法。 | 指派給網站訪客的不重複、永久性 ID。這個確切實體可供 Experience Platform 身分識別服務使用。[更多內容...](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=zh-Hant) |
...
| **區段** | 不適用 | 一組規則的輸出，用於判斷客群的資格。在 Analytics 中，[細分群體](https://experienceleague.adobe.com/docs/analytics/components/segmentation/seg-home.html?lang=zh-Hant)可選擇性用來定義可傳遞至 Experience Cloud 的客群。<br>在 Audience Manager 中，區段是[特徵](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/traits/traits-overview.html?lang=zh-Hant)及判斷訪客是否符合成員資格或納入該區段資格的所有條件之集合。此外，也代表具有共同屬性的一群人。 |
