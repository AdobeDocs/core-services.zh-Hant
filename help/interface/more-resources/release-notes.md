...
| 日期 | 更新 | 說明 |
| ------- | ------- | ------- |
| 2026年6月1日 | Agentic AI使用監控 | CX Enterprise現在提供儀表板，可監控現有應用程式中代理程式人工智慧的使用情況。 針對透過AI Assistant和其他對話介面存取的Experience Platform代理程式，追蹤採用、檢閱交談和回饋，以及管理AI點數消耗。 概述、使用者、意見和AI評分檢視有助於控管利害關係人引導資料採用。 檢視[Agentic AI監視](../features/monitoring.md)儀表板存取和許可權。 |
