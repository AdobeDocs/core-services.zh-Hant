...
* [訪客ID服務](https://experienceleague.adobe.com/en/docs/id-service/using/intro/overview)：訪客ID服務一律會設定第一方Cookie，無論您的資料收集網域是否符合您網站的網域。 它會使用JavaScript將Cookie放在網站的網域上。
