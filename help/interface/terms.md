...
| [!UICONTROL Experience Platform Identity Service] | 無特殊用法。 | 連結身分的服務。 它是提供人員型體驗管理的裝置連結服務。 |
...
| 特性 | 不適用 | 鍵值對，例如color=blue。 在Audience Manager中， [特徵](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/traits/traits-overview.html) 可用來建立區段。 |
