...
Experience Cloud中央介面元件的功能、發行說明和已知問題。

如需文件更新的清單，請參閱 [Experience Cloud](doc-updates.md#concept_4C8983FCD23848A4B1E4C2D99ED82784)。

如需所有解決方案的發行說明，請參閱 [Experience Cloud 發行說明](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=en)。

## 2021年6月

| 功能 | Date | 說明 |
| ------- | ------- | ------- |
| AdobeFederated ID的單一登入支援 | 2021 年 6 月 17 日 | 如果您使用Federated ID，則無需輸入電子郵件地址或密碼即可登入Experience Cloud。 若要使用此功能，請將`#/sso:@domain`新增至Experience CloudURL。 <br>例如，假設您擁有網域， `adobecustomer.com` 且想登入Adobe Analytics。URL會是：`https://experience.adobe.com/#/sso:@adobecustomer.com/analytics`。 |
| Experience League搜尋 | 2021 年 6 月 1 日 | Experience League檔案搜尋功能已改善。 導覽至[Experience League](https://experienceleague.corp.adobe.com/docs/?lang=en)並使用&#x200B;**[!UICONTROL Search]**&#x200B;欄位來尋找教學課程、檔案、課程等。 |
...
* 「摘要」頁面已於2019年12月汰除。 請參閱產品中的淘汰通知。(MCUI-10039)
...
<table id="table_ABBCE1A66F534059BD728BC2B9AEFA80"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Experience Cloud客戶管理員可使用預先建立並對應至Analytics和Dynamic Tag Management預設權限群組的產品設定。 </p> <p>此最佳化適用於新佈建的組織，且可縮短組織在 Admin Console 中管理使用者所需的時間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>摘要改善 </p> </td> 
   <td colname="col2"> <p> 在「Experience Cloud摘要」中建立貼文時，「收件者」行現在預設會使用目前作用中的主題，而非使用組織。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_C9B288CF42034F329C3C72D95D22E515"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>在 Experience Cloud 資產中，您可以從單一中央位置儲存、共用及同步數位資產。Experience Cloud資產使用<span class="keyword"> Adobe Experience Manager</span>(AEM)中提供的部分功能。 </p> <p>請參閱 <a href="experience-cloud-assets.md#concept_DDA5224C907D4A4F817D795DA0ED64D0" format="dita" scope="local">Experience Cloud</a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>帳戶連結改善 </p> </td> 
   <td colname="col2"> <p>改善連結解決方案帳戶與 Experience Cloud (Adobe ID) 的介面工作流程。這個新的工作流程會找出與組織相關聯的所有使用者帳戶，並讓您選擇要連結的帳戶。我們也簡化了帳戶連結體驗，因此您不再需要存取「管理組織」頁面才能手動連結帳戶。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
如果您透過「**[!UICONTROL Experience Cloud]** > **[!UICONTROL 啟用]**」介面存取動態標籤管理，但您的動態標籤管理帳戶未連結至 Experience Cloud (Adobe ID)，便無法登入動態標籤管理。 請在新的瀏覽器分頁中直接導覽至 `dtm.adobe.com`，即可避免此問題。
...
>[!NOTE]
>
>Microsoft®對Internet Explorer 8、9和10的[終止支援](https://www.microsoft.com/zh-tw/WindowsForBusiness/End-of-IE-support)。 有鑑於此，我們將不修正針對這些特定版本 Internet Explorer 所回報的問題。
  ...
  <tr> 
   <td colname="col1"> <p>管理改善： </p> 
    <ul id="ul_7D5FCBEFA262435D865CA1018BFB792E"> 
     ...
     <li id="li_8CDAB6301FD44C3999EE4EEB1A0A2FD6">企業和Federated ID支援 </li> 
    </ul> </td> 
...
* 將動態標籤管理組織與 Experience Cloud 連結及取消連結的功能，無法用於新建立的 Experience Cloud 組織。Adobe正在修正此問題，並在5月發行版本中恢復正常功能。 如果您在嘗試透過 Experience Cloud 以單一登入的方式登入動態標籤管理時發生問題，請在 [!DNL dtm.adobe.com] 使用舊版登入。
...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="activation.md#concept_EE756B6B0A0643DAB8CA3A00E665406C" format="dita" scope="local">啟用</a>現在顯示在 <span class="keyword">Experience Cloud</span> 的左側導覽器中。<span class="wintitle"> </span> Activation是Experience  <span class="keyword"> Cloud</span> 服務，目前由動態標籤管理技術組成，只要按一下，系統就會將您導向過去。 </p> </td> 
  </tr> 
  <tr> 
...
* 如果在 [!DNL Creative Cloud] 中將 [!DNL Experience Cloud] 內容取消共用，該內容也可能會從某些使用者的資料夾中移除。
* 15 分鐘無活動，系統就會將您登出。此外，從某個位置登出會將您登出[!DNL Experience Cloud]。
...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol">「Experience Cloud</span> &gt; <span class="uicontrol">說明</span> &gt; <span class="uicontrol">Exchange」</span></p> <p><span class="keyword">Experience Cloud</span><span class="wintitle">Exchange</span> 是可讓您透過應用程式來搜尋、瀏覽、選擇、支付及下載數位行銷擴展元件的多合一路徑。 </p> <p>應用程式包括Data Connectors、Adobe核心產品的自訂設定、協力廠商應用程式、報表，以及<span class="keyword">Experience Cloud</span>卡片。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Experience Cloud 受眾 </p> </td> 
   <td colname="col2"> <p> <span class="uicontrol">「Experience Cloud</span> &gt; <span class="uicontrol">受眾」</span></p> <p> 您可以使用類似於處理區隔的方式，在<span class="wintitle">「受眾」</span>建立、編輯及管理受眾。例如，您可以在Reports &amp; Analytics中建立區段，然後共用至<span class="wintitle">Experience Cloud</span><span class="wintitle">對象</span>。 共用後，您便可將受眾用於 <span class="keyword">Adobe Target</span> 中的行銷活動以及 Adobe Audience Manager 中的區隔。 </p> <p> <p>注意：若要請求Target啟用，請造訪<a href="https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?idx=X8SVES" format="http" scope="external"> https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?idx=X8SVES</a>。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>新Adobe使用者可將其Scene7帳戶連結至Adobe ID及其團隊成員。 管理員也可以將使用者與 Scene7 帳戶取消連結。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>資產同步。 </p> </td> 
   <td colname="col2"> <p> 您可以與Experience Manager資產共用Experience Cloud和Creative Cloud。 對這些資產的任何變更都會反映在Experience Cloud和Creative Cloud中資產的共用副本中。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 使用者無法在展示板上共用 PowerPoint 檔案。
* 有些使用者在Internet Explorer 10中遇到視覺版面不佳的問題。
...
14.3.1版是著重於速度、穩定性和安全性的維護髮行。 其中不包含主要的新功能。
