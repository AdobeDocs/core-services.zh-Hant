...
| **Adobe Journey Optimizer B2B edition** | 不適用 | 可提供產品知識方面的協助。 [了解更多](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | 無 |
| **[!DNL Campaign]受管理的雲端服務** | 不適用 | 內容加速器可讓您根據各管道（例如電子郵件、簡訊和推播）的行銷目標，自動產生個人化、吸引人且有效的內容。 [了解更多](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | 是 |
...
| **[!DNL Workfront]** | GenAI已搭配[應用程式內](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en)資訊和建議使用。 了解更多 | 不適用 | 是 |
