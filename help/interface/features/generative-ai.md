...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | 適用於Performance Marketing的GenStudio是genAI應用程式。 它可協助行銷和創意團隊建立個人化的品牌內內容。 | 不適用 | 是 |
| [Adobe Experience Manager Sites](#aem) | GenAI用於[產生變化](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en)，以根據輸入建立內容變化。 | 不適用 | 是 |
| [Sites Optimizer](#aem) | GenAI可協助您分析及改進網頁體驗的效能和有效性。 | 不適用 | 無 |
| [Adobe Experience Manager Assets](#aem) | GenAI用於[Content Hub](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en)和AI產生的[智慧標籤](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags)。 | 不適用 | 是 |
| [Adobe Journey Optimizer](#journey-optimizer) | 不適用 | 適用於產品知識和營運深入分析。 | 無 |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | 不適用 | 可提供產品知識方面的協助。 | 無 |
| [[!DNL Campaign] 受管理的雲端服務](#campaign-cs) | 不適用 | 內容加速器可讓您根據各管道（例如電子郵件、簡訊和推播）的行銷目標，自動產生個人化、吸引人且有效的內容 | 是 |
...
| [[!DNL Real-Time CDP]](#rtcdp) | 不適用 | 適用於Experience League的產品知識。 此外，還提供營運深入分析（測試版）。 | 無 |
...
| [[!DNL Workfront]](#workfront) | GenAI已搭配[應用程式內](https://experienceleague.adobe.com/zh-hant/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en)資訊和建議使用。 | 不適用 | 是 |
