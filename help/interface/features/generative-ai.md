...
description: 深入瞭解如何在CX Enterprise應用程式中利用AI支援的功能。
...
# CX Enterprise中的Generative AI

CX Enterprise中的Generative AI (genAI)可幫助您自動化創意和認知任務並提高生產力。 本頁可協助您瞭解CX Enterprise應用程式在何處支援genAI和AI Assistant，並提供連結以深入瞭解這些功能。

>[!IMPORTANT]
>
>在使用CX Enterprise Generative AI功能之前，您必須瞭解並遵循[Adobe CX Enterprise Generative AI使用者准則](https://www.adobe.com/tw/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html)。
...
* **產品知識：**&#x200B;產品知識是指以Experience League上的CX Enterprise產品檔案為基礎的概念和主題。 例如，使用[目標型提示](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/ai-assistant/home)來快速瞭解Experience Platform。 來自Experience League的所有回應都是可驗證的，並會透過連結引用。
...
>[!NOTE]
>
>許多CX Enterprise應用程式使用&#x200B;_AI助理_&#x200B;作為功能名稱（如下所述）。 不過，此功能只會提取您使用之特定應用程式的資訊。 例如，AEM中的AI助理可提供與AEM相關的實用資訊。
...
以下是使用generative AI功能和AI Assistant的[!DNL CX Enterprise]應用程式彙總。 已指出產生AI功能與[Adobe Firefly](https://business.adobe.com/tw/products/firefly-business/firefly-ai-approach.html)的相容性。
...
**注意：** [!DNL Experience Platform Agents]已在CX Enterprise中的[AI代理程式中說明](agentic-ai.md)。

## 如何在CX Enterprise中使用創作AI？
...
Journey Optimizer B2B Edition使用[!UICONTROL AI Assistant]來協助您掌握產品知識。
...
Marketo Engage [!UICONTROL Email Designer]中的[!UICONTROL AI Assistant]可協助您建立現代、高效且直覺式的電子郵件。 這是透過Adobe的創作AI技術和提示程式庫，以及Firefly來實現的，用於產生影像，協助為特定角色/購買群組、行銷歷程階段、溝通策略、音調等建立合適的內容。也可以使用特定品牌資產來建立內容。
...
[!DNL Workfront]中的[!UICONTROL AI Assistant]會提供應用程式內資訊和建議，協助您完成工作。 您可以：
...
**免責宣告：**&#x200B;此頁面上的資訊僅供一般參考。 雖然會努力確保資訊保持正確且最新，但軟體和創作AI功能可能會經常變更。 因此，Adobe並不保證資訊隨時都能完整、準確或可靠。 在根據此內容做出決定之前，請驗證任何重要細節。
