...
| [Sites Optimizer](#aem) | GenAI可協助您分析及改進網頁體驗的效能和有效性。 | 不適用 | 無 | [!BADGE 了解更多]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="前往Experience League上的Sites Optimizer"} |
...
| [Adobe Journey Optimizer](#journey-optimizer) | 不適用 | 適用於產品知識和營運深入分析。 | 無 | [!BADGE 了解更多]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="瞭解AJO中的AI助理"} |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | 不適用 | 可提供產品知識方面的協助。 | 無 | [!BADGE 了解更多]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="瞭解AJO中的AI助理"} |
| [[!DNL Campaign] 受管理的雲端服務](#campaign-cs) | 不適用 | 內容加速器可讓您根據各管道（例如電子郵件、簡訊和推播）的行銷目標，自動產生個人化、吸引人且有效的內容 | 是 | [!BADGE 了解更多]{type=Informative url="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs" tooltip="瞭解AJO中的AI助理"} |
