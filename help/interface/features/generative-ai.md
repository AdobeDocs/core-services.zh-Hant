...
| [Adobe Experience Manager as a Cloud Service (AEM CS)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/overview) | GenAI提供於：<ul><li>在[AEM Sites](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor)中&#x200B;**產生變數**</li><li>[Sites Optimizer](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview)中的&#x200B;**GenAI**</li><li>[AEM Assets](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en)中的[Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags)和&#x200B;**智慧標籤**</li></ul> AI助理用於： <ul><li>Experience Hub概觀頁面<li>Edge Delivery Services</li><li>網站</li><li>資產</li><li>Forms</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> | 是 |
| [Adobe Experience Manager 6.5](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | AI助理用於： <ul><li>Experience Hub概觀頁面<li>Edge Delivery Services</li><li>網站</li><li>資產</li><li>Forms</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> | 是 |
| [Adobe Experience Manager 6.5 LTS](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | AI助理用於： <ul><li>Experience Hub概觀頁面<li>Edge Delivery Services</li><li>網站</li><li>資產</li><li>Forms</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> | 是 |
| [LLM Optimizer](https://experienceleague.adobe.com/en/docs/llm-optimizer/using/home) | 創作、AI優先的應用程式，使用AI代理程式來自動識別可見度差距、自動建議改善專案，並在特定情況下自動最佳化您的網站體驗。 | 無 |
...
[!BADGE 了解更多]{type=Informative url="https://experienceleague.adobe.com/en/docs/llm-optimizer/using/home" tooltip="瞭解LLM Optimizer"}
