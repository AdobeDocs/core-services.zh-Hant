...
管理員使用此儀表板來追蹤權利的授權使用情況。 若要存取儀表板，請參閱[!DNL Experience Platform]檔案中的[授權使用儀表板](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/dashboards/guides/license-usage)。
