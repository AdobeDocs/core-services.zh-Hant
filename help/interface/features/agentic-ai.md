...
Adobe [!DNL Experience Platform] [Agent Orchestrator](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-ai/experience-cloud-ai/home)是在Adobe [!DNL Experience Cloud]中建置及協調Expert AI代理程式的核心技術。

您可以透過以下其中一種方式取得AI代理程式的存取權：

* [現有 [!DNL Experience Cloud] 應用程式](#existing-apps) （使用AI代理程式需要授權）
* [AI-First [!DNL Experience Cloud] 應用程式](#ai-first-apps) （代理程式是應用程式的原生）

## 現有[!DNL Experience Cloud]個應用程式

現有應用程式可自行運作，但新增AI代理程式可為您提供額外的功能和影響力。 如果您有[!DNL Platform Agent Orchestrator]的授權，則可以在您有權使用的應用程式中使用[!DNL Platform Agents]。
...
這些應用程式是以AI為核心所建置。 他們使用產生式或代理式AI執行關鍵任務，並且AI代理已包含在應用程式授權中，無需Agent Orchestrator附加元件。
