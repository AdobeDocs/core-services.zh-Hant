...
| **品牌治理代理程式*** | <ul><li>[品牌治理](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview):Safeguard品牌完整性與法規遵循可透過自動化品牌原則檢查、許可權、智慧來支援DRM與即時治理。</li></li></ul> |
