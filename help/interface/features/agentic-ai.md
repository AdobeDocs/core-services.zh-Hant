...
| [品牌治理代理程式](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview)* | <ul><li>透過自動化品牌政策檢查、許可權和智慧來保障品牌完整性和合規性，以透過即時控管支援DRM。</li> | <ul><li>Adobe Experience Manager Assets</li><li>Adobe Experience Manager Sites （品牌政策）</li></ul> |
