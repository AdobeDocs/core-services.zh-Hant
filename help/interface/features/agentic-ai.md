...
| [內容最佳化代理程式](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/content-optimization/using)* | 可用 | 使用自然語言提示簡化從來源資產建立視覺內容變體的過程。 | <ul><li>Adobe Experience Manager （含[Dynamic Media with OpenAPI](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview)）</li></ul> |
| [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) | 可用 | 快速解答有關您資料的資料問題。 它會使用您資料檢視中的元件，並使用您的實際資料，在Analysis Workspace中建置相關的視覺效果。 | <ul><li>Customer Journey Analytics</li></ul> |
| [開發代理程式](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/development/overview)* | 可用 | 透過分析根本原因並提出修正建議，協助AEM CS開發人員和技術管理員疑難排解Cloud Manager管道中的建置步驟失敗。 | <ul><li>AEM Cloud Service和Adobe Managed Services中的AI助理</li></ul> |
| [探索代理](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/discovery/using)* | 可用 | 透過簡化的自然語言提示，加速撰寫並提升探索速度，即時尋找並呈現影像、影片、文字型檔案、內容片段和表單中的Experience Manager內容。 | <ul><li>Adobe Experience Manager雲端服務</li></ul> |
| [體驗生產代理程式](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/production/overview)* | 可用 | 在CMS中自動化大量工作與大量工作。 此代理程式將手動、冗長的流程轉換為快速的AI輔助工作流程，讓每個體驗保持最新且一致，協助您的企業達成目標。 | <ul><li>Adobe Experience Manager Cloud Services與Edge Delivery Services</li></ul> |
...
| 代理程式名稱 | 可用性 | 功能 | 支援的應用程式 |
|---|----------|----------|----------|
| [Experimentation Agent](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/content-experiment/experiment/experiment-accelerator-security) | 可用 | 自動化、分析和綜合深入分析，讓您從集中式工作區中快速找出高影響力的實驗和發展機會，同時減少手動程式。 | <ul><li>AJO Experimentation Accelerator</li></ul> |
...
| [Product Advisor Agent](https://experienceleague.adobe.com/en/docs/brand-concierge/content/documentation/overview) | 可用 | 透過根據個人偏好和行為量身打造的智慧型內容感知產品探索，促進轉換和參與。 | <ul><li>Adobe Brand Concierge</li></ul> |
