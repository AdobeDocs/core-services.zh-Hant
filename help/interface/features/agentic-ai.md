...
| [探索代理程式](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/business-agents/discovery/using) | 可用 | 透過簡化的自然語言提示，加速撰寫並提升探索速度，即時尋找並呈現影像、影片、文字型檔案、內容片段和表單中的Experience Manager內容。 | <ul><li>Adobe Experience Manager雲端服務</li></ul> |
