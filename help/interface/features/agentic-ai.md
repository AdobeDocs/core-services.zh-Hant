...
| [Journey Agent](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent) | 讓您的團隊快速分析和最佳化大規模的多點觸控客戶歷程。 | <ul><li>Adobe Journey Optimizer （B2B和B2C版本）</li></ul> | |
...
* [CX Enterprise Agentic Tools](https://experienceleague.adobe.com/zh-hant/docs/cx-enterprise-agentic-tools/using/overview#adobe-cx-enterprise-agentic-tools)
