---
description: 瞭解如何登入以及CX Enterprise中的中央介面元件。 了解全域搜尋、您的帳戶偏好設定，以及如何瀏覽介面及取得說明。
...
CX Enterprise支援每位使用者偏好的語言，如同您的Adobe使用者帳戶偏好設定中所設定。 目前支援的語言如下：
...
雖然所有應用程式團隊都致力於提供全球語言的支援，但並非所有應用程式都有提供上述的所有語言版本。 如果CX Enterprise應用程式不支援您的主要語言，您也可以將次要語言設定為預設語言（如適用）。 您可以在[CX Enterprise使用者偏好設定](https://experience.adobe.com/preferences)中進行這項設定。
...
1. 按一下「**[!UICONTROL Sign in with an Adobe ID]**」。
1. 確認您隸屬於正確的組織。

   ![確認您的組織](assets/organizations-menu.png)

   若要確認您已登入正確的組織，請按一下&#x200B;**[!UICONTROL Profile]**&#x200B;檢視組織名稱。 如果您擁有多個組織的存取權，也可以使用&#x200B;**[!UICONTROL Organization]**&#x200B;選擇器檢視並切換至另一個組織。
...
## CX Enterprise中的搜尋和支援

CX Enterprise搜尋可讓您搜尋[Experience League](https://experienceleague.adobe.com/zh-hant#home)的說明（檔案、教學課程和其他課程）。

![在CX Enterprise中搜尋和支援](assets/search-menu.png)
...
### 管理CX Enterprise [!UICONTROL Preferences]

CX Enterprise偏好設定包括通知、訂閱和警示。

* 從您的帳戶功能表![偏好設定](assets/preferences-icon-sm.png)按一下&#x200B;**[!UICONTROL Preferences]**&#x200B;以管理偏好設定。

![管理CX Enterprise](assets/preferences-page.png)

您可以在[!UICONTROL CX Enterprise preferences]上設定下列功能：

| 功能 | 說明 |
| --- | --- |
| 預設組織 | 選取當您啟動CX Enterprise時想要看到的組織。 |
...
| [!UICONTROL Alerts] | 選取您想要看到警示顯示在瀏覽器的通知。 警示會出現在視窗的右上角幾秒鐘。 |
...
按一下&#x200B;**[!UICONTROL Notifications]**&#x200B;以檢視對您重要的通知以及來自Adobe的公告。
