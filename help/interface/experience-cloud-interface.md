...
### 管理Experience Cloud [!UICONTROL Preferences]

Experience Cloud 偏好設定包括通知、訂閱和警示。

* 從您的帳戶功能表&#x200B;**[!UICONTROL Preferences]**&#x200B;偏好設定![按一下](assets/preferences-icon-sm.png)以管理偏好設定。
