...
| **(僅限 Adobe Target)** 以客戶屬性將資料上傳至 Adobe Target 是否會延長 Adobe Target 訪客的個人資料存留期？ | 是。請參閱 Adobe Target 說明中的[訪客個人資料存留期](https://experienceleague.adobe.com/docs/target/using/audiences/visitor-profiles/visitor-profile.html?lang=en)。 |
