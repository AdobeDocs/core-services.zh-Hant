...
| 我要如何開始使用 [!DNL Customer Attributes]？ | <ol><li>完成佈建程序。如果您是 Analytics 客戶，Adobe 會針對 [!DNL Customer Attributes] 為您完成佈建。如果您只使用 Adobe Target 而沒有使用 Analytics，請連絡客戶服務，申請佈建核心服務。</li> <li>與您的 CRM 團隊溝通。了解您想要在 Analytics 和整個 Experience Cloud 使用的客戶資料中有哪些類型可用。</li><li>實作核心服務。 如需如何導入最新實作的步驟，請參閱[為核心服務啟用您的應用程式](core-services.md)。(如需重要資訊，請參閱同步化客戶 ID 的相關章節)。</li></ol> **注意：**[這裡](faq.md)提供實作核心服務的管理員常見問題集。 |
