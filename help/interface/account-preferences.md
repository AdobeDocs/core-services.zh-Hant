...
| [!UICONTROL 個人化學習推薦和促銷] | 選取您想要在哪裡收到有關Adobe產品的個人化說明。 這類幫助可透過電子郵件、在產品內和在 Experience League 社群中取得。[了解更多。](personalized-learning-preferences.md) |
| [!UICONTROL 訂閱] | 選取您想要訂閱的產品和類別。 中的通知 [!UICONTROL 通知] 在您的電子郵件中彈出視窗和。 |
| [!UICONTROL 優先順序] | 選取您希望被視為高優先順序的類別。 這些類別標有 [!UICONTROL 高] 標籤，並可設定為像警示一樣遞送。 |
