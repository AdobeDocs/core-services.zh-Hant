...
| 功能 | 說明 |
|--- |--- |
| 大量報表套裝對應 | 在「管理 > 報表套裝對應」中，您現已可選取多個報表套裝，然後將它們對應至某個組織(之前您必須個別對應這些報表套裝。)<br>[對應報表套裝](core-services.md) 至單一組織有助於在Experience Cloud中啟用跨應用程式功能與服務。 |
