...
>[!NOTE]
>
>共用的CX Enterprise資料夾和資產是以1:1的關係映象到Creative Cloud案頭。 如果CX Enterprise使用者變更資料夾（刪除、新增或移除共用），動作會反映到Creative Cloud案頭和網頁中。 因此，如果資料夾取消共用，資料夾和資產會從本機電腦中刪除。 移除共用後，資料夾及其內容會移至本機電腦上的垃圾桶，您可在此手動將它們還原至電腦。
