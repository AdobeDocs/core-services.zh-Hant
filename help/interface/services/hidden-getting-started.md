...
CX Enterprise功能表導覽中提供&#x200B;**[!UICONTROL Admin Console]**&#x200B;連結。
...
## 實作[!UICONTROL CX Enterprise ID服務] {#section_3C9F6DF37C654D939625BB4D485E4354}
...
如需完整的CX Enterprise ID服務說明（先前稱為訪客ID），請至[這裡](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=zh-Hant#intro)。
