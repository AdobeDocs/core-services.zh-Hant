...
啟用CX企業核心服務最簡單的方法，就是透過[!UICONTROL Experience Platform Launch]中的[CX Enterprise ID Service擴充功能](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html)，為Analytics和Adobe Target自動啟用。
...
* 建議您在[!UICONTROL Adobe Target]標籤中新增[Experience Platform擴充功能](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/target-v2/overview.html)，以便讓資料庫擷取作業自動執行。 您也可以使用[!UICONTROL Enterprise ID]標籤為Adobe Target （和其他應用程式）設定[CX Experience Platform服務擴充功能](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html)。 Adobe Target需要[!UICONTROL CX Enterprise ID服務]更新&#x200B;**&#x200B;**&#x200B;才能使用People服務。
