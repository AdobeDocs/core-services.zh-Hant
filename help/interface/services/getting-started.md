...
如果您最近使用[Experience Platform標籤](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/tags/home)實作Experience Cloud，則您已為[客戶屬性](../services/overview.md)和Experience Cloud [對象](../services/audiences/overview.md)完成設定。 您也可以在[Admin Console](../administration/admin-console.md)中管理使用者和產品。
...
請參閱[在 Experience Cloud 中連結帳戶](https://experienceleague.adobe.com/zh-hant/docs/core-services/interface/administration/organizations)
...
啟用Experience Cloud核心服務最簡單的方法，就是透過[中的](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html?lang=zh-Hant)Experience Cloud ID服務擴充功能[!UICONTROL Experience Platform Launch]，為Analytics和Adobe Target自動啟用。

>[!NOTE]
>
>如需完整的Experience Cloud ID Service說明（先前稱為訪客ID），請參閱[Experience Cloud Identity Service概觀](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=zh-Hant#intro)。
...
| 任務 | 說明 |
|--- |--- |
| [實作適用於 Analytics 的 Experience Cloud ID Service](https://experienceleague.adobe.com/zh-hant/docs/analytics/implementation/id/overview) | Adobe 也建議設定其他[客戶 ID](https://experienceleague.adobe.com/zh-hant/docs/id-service/using/reference/authenticated-state)。這些 ID 與每個訪客相關聯，實現了 Experience Cloud 中的現有和未來功能。 |
...
* 建議您在[標籤中新增](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/target-v2/overview.html?lang=zh-Hant)Adobe Target擴充功能[!UICONTROL Experience Platform]，以便讓資料庫擷取作業自動執行。 您也可以使用[標籤為Adobe Target （和其他應用程式）設定](https://experienceleague.adobe.com/docs/experience-platform/tags/extensions/adobe/id-service/overview.html?lang=zh-Hant)Experience Cloud ID服務擴充功能[!UICONTROL Experience Platform]。 需要[!UICONTROL Experience Cloud ID Service]更新&#x200B;**&#x200B;**，Adobe Target才能使用人員服務。
